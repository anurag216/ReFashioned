...
SELECT is(
  ...
  ARRAY[
    ...
    'get_evidence_download_target(p_evidence_id uuid)','get_my_organization_evidence(p_product_id uuid)','get_organization_access_admin_view()',
    'get_my_supplier_access()','get_my_supplier_evidence_tasks()','get_product_passport_publication_state(p_product_id uuid)',
    'get_organization_member_invite_metadata(p_token text)','get_public_product_passport(p_public_slug text)','get_supplier_access_admin(p_supplier_id uuid)',
