...
RESET ROLE;
SELECT set_config('request.jwt.claim.sub','b0000000-0000-0000-0000-000000000004',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claim.sub','b0000000-0000-0000-0000-000000000005',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000004","email":"replace@test.invalid","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000004","email":"expired@test.invalid","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000008","email":"wrong-email@test.invalid","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000004","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000004","email":"identity-supplier@test.invalid","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
...
SELECT set_config('request.jwt.claims','{"sub":"b0000000-0000-0000-0000-000000000007","email":"conversion@test.invalid","role":"authenticated"}',true); SET LOCAL ROLE authenticated;
